...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "generation_defaults": {  # Default parameters for TTS audio generation.
        "temperature": 0.7,  # Controls randomness: lower is more deterministic/faithful.
        "exaggeration": 0.5,  # Expressiveness. ~0.5 is realistic; >0.8 destabilizes the clone.
    ...
    "audio_output": {  # Settings related to the format of generated audio.
        ...
        "max_reference_duration_sec": 60,  # Cap for reference audio; longer is trimmed. More clean speech steadies the speaker embedding.
        "reference_cleanup": False,  # Default for the "clean up reference" option (denoise/trim-silence/normalize).
